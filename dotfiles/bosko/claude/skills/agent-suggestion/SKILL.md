...
Cutoff looks off, or a tool call misbehaving? Check `references/gotchas.md` for three known misfire patterns before trusting Step 1's cutoff or a raw tool call.
