...
Before trusting Step 0's cutoff or Step 1's script path, read `references/gotchas.md` for known failure modes (stale cutoff, wrong script path, drifted inline tables).
