...
Fill the two metadata stamps so the file matches the shape harness-written memories use — omitting them leaves the file inconsistent with the rest of the store:
