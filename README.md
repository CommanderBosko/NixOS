...
- Swappable desktop environment modules (12 options under `desktop-environments/`, including a from-scratch Omarchy-style Hyprland module added 2026-07-10); gaming switched to Niri 2026-07-08 (pending reboot), laptop already on Niri, natalie-laptop on Plasma 6
...
.claude/skills/                         # Project-local Claude Code skills (32 total)
...
- Apply rebuild + reboot on laptop and natalie-laptop: activate managed Claude Code policy, natalie-laptop DE switch to Plasma, FinanceGuru, package consolidation changes, and the OnlyOffice font fix; remove hand-maintained `~/.ssh/config` on each host afterward
