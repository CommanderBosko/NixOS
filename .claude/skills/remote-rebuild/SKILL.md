...
If the deploy fails, or you need to justify why `boot`+reboot beats `switch` here, read `references/gotchas.md` for the three root-caused failure modes before improvising a fix.
