...
If step 5 fails, check `references/gotchas.md` before concluding the update itself is bad — some failures are insecure-package gates or under-verification, not real breaks.
