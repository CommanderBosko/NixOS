...
Before flagging a security/hardening finding, check `references/known-workarounds.md` for documented intentional deviations. When in doubt whether something is intentional, read the relevant memory file before reporting it.
