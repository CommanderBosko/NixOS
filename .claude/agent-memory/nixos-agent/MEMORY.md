...
- [dbus-broker default change in nixpkgs unstable](project_dbus_broker_default.md) — COMPLETE on all 5 hosts; plain assignment in security.nix beats nix-flatpak's bundled mkDefault "dbus"
