...
- [dbus-broker default change in nixpkgs unstable](project_dbus_broker_default.md) — ALL hosts COMPLETE (natalie-laptop staged, pending reboot); per-host mkForce overrides removed; no explicit setting needed
